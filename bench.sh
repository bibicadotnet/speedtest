...
speed() {
    ...
    speed_test '63143' 'Hong Kong, HK'; speed_test '2054' 'Singapore, SG'; speed_test '48463' 'Tokyo, JP'
    speed_test '67826' 'FPT Telecom, VN'; speed_test '45493' 'VNPT-NET, VN'; speed_test '10040' 'Viettel, VN'
}
