...
speed() {
    ...
    speed_test '63143' 'Hong Kong, HK'; speed_test '67827' 'Singapore, SG'; speed_test '50467' 'Tokyo, JP'
    speed_test '67826' 'FPT Telecom, VN'; speed_test '45493' 'VNPT-NET, VN'; speed_test '27598' 'Viettel, VN'
}
