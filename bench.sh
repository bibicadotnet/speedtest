...
speed() {
    ...
    speed_test '63143' 'Hong Kong, HK'; speed_test '31293' 'Singapore, SG'; speed_test '50467' 'Tokyo, JP'
    speed_test '44677' 'FPT Telecom, VN'; speed_test '17756' 'VNPT-NET, VN'; speed_test '9903' 'Viettel, VN'
}
